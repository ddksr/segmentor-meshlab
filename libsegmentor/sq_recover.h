...
extern int recover_search(struct vect *list, int no, double *a1, double *a2, double *a3, double *e1, double *e2, double *px, double *py, double *pz, double *fi, double *theta, double *psi, double *kx, double *ky, double *bk, double *ba, int rtype);
extern int recover2(struct vect *list, int no, double *a1, double *a2, double *a3, double *e1, double *e2, double *px, double *py, double *pz, double *fi, double *theta, double *psi, double *kx, double *ky, double *bk, double *ba, int rtype);
